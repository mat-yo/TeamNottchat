...
# load json file
intents = json.loads(open('TeamNottchat_intents.json').read())

# load the bytestream 
words = pickle.load(open('TeamNottchat_words.pkl','rb'))
classes = pickle.load(open('TeamNottchat_classes.pkl','rb'))
